...
\fbox{\begin{minipage}{\linewidth}
	...
	\begin{equation}
		...
		\begin{split}
			Goal(k)=H & \wedge ksk \not \in Roles(k)\\
			\\
			Goal(k)=H 	& \wedge T_{now} \geq T_{whatever}
		\end{split}
	...
	\begin{equation}
		\begin{split}
			Goal(k)=H 	& \wedge T_{now} < T_{whatever} \\
						& \rightarrow [event]
		\end{split}
	\end{equation}
\end{minipage}}
...
\fbox{\begin{minipage}{\linewidth}
	...
	\begin{equation}
		\begin{split}
			Goal(k)=H \wedge T_{now} < T_{whatever} \rightarrow event(T_{whatever})
		\end{split}
	\end{equation}
\end{minipage}}
...
Enough time passed to propagate signatures.
	\begin{equation}
		\begin{split}
			Goal(k)=O \wedge T_{now} \geq T_{whatever} \rightarrow O(Rrsig(k))
		\end{split}
	\end{equation}
